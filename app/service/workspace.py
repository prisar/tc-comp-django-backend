...
from app.models import Workspace, WorkspacesRule, WorkspacesMember, WorkspacesProject
...
class WorkspaceService:
    ...
    def delete_workspace(self, id, user_dict):
        """
        delete workspace
        :param id: workspace id
    ...
    def get_workspace_list(self, offset, limit, order, user_id):
        """
        ...
        # filter workspaces
        results = list()
        workspaces = Workspace.objects.filter(id__in=workspace_ids).order_by(sort_by)[offset:offset + limit]
    ...
    def search_workspaces(self, user_dict, query):
        """
        search workspaces
        :param user_dict: user dictionary
    ...
    def create_new_workspace(self, user_dict, data):
        """
    ...
    def update_workspace(self, id, user_dict, data):
        """
        update workspace
        :param id: workspace id
        :param user_dict: user dictionary
    ...
    def delete_and_insert_members(self, workspace, member_ids):
        """
        delete and insert members
    ...
    def delete_and_insert_projects(self, workspace, project_ids):
        """
        delete and insert projects
        :param workspace: workspace
    ...
    def delete_and_insert_rules(self, workspace, rule_ids):
        """
        delete and insert rules
        :param workspace: workspace
    ...
    def copy_workspace(self, id, user_dict, data):
        """
        copy
        :param id: workspace id
        :param user_dict: user dictionary
    ...
    def check_is_member(self, workspace_id, user_id):
        """
    ...
    def add_members(self, workspace_id, user_id):
        """
    ...
    def add_projects(self, workspace_id, project_id):
        """
    ...
    def add_rules(self, workspace_id, rule_id):
        """
